...
- Start by reading the project's plan or spec if one exists (typically
  `docs/implementation-plan.md` or `docs/spec.md`). If not, your first
  job is to draft one. Ask clarifying questions before committing to a
  design.
